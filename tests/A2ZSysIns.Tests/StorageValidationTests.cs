...
namespace A2ZSysIns.Tests
{
    ...
    public class StorageValidationTests
    {
        ...
        public void IndividualTargetsClassifyStorageAndPreferSerialMatch()
        {
            ...
            var staleIndexTarget = new IndividualStorageInspectionService.Target
            {
                Index = 0,
                Model = "Same Model",
                Serial = "SERIAL-B",
        ...
        public void IndividualTargetMismatchFailsSafely()
        {
            ...
            var target = new IndividualStorageInspectionService.Target
            {
                Index = 0,
                Model = "Drive B",
                Serial = "SERIAL-B",
        ...
        {
            return new DriveInfoRecord
            {
                Model = model,
                Serial = serial,
                SizeBytes = sizeGb * 1000L * 1000L * 1000L
            };
        }
